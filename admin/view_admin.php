            ...
            while ($rs = mysqli_fetch_array($result)) {
              ...
              <tr>
                ...
                <td align='center'><a href="#modalRegisterFormsss?id=<?php echo $id; ?>">
                    <i class="fas fa-user-edit" data-toggle="modal" data-target="#modalRegisterFormsss"></i> </a> | <a
                    href="delete_admin.php?id=<?php echo htmlentities($rs['id']); ?>"><i class='far fa-trash-alt'></i></a>
                </td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body mx-3">
          ...
          <div class="md-form mb-5">
            ...
            <input type="email" id="orangeForm-email" name="admin_user" value="<?php echo $admin1; ?>"
              class="form-control validate">
          ...
          <div class="md-form mb-4">
            ...
            <input type="password" id="orangeForm-pass" name="admin_password" value="<?php echo $pass1; ?>"
              class="form-control validate">
